  ...
  return (
    <div className="container-fluid x">
      <div className="container my-5 ">
        <div className="row">
          <div className="col-12 col-md-8 offset-md-2 fw-bold text-dark">
            ...
            <p>
              ...
              and provide the best possible customer service. Our knowledgeable
              and friendly support team is available 24/7 to answer any
              questions you may have.
            </p>
            <p>
              Our easy-to-use website and mobile app make shopping simple,
              whether you're at home or on the go. We're dedicated to providing
              a secure and trustworthy platform for our customers, and we use
              state-of-the-art technology to ensure the safety and privacy of
              your personal information. We also employ strict security
